...
在本讲中，我们将介绍一维离散时间动力学的基础知识。

（尽管大多数定量模型有两个或更多的状态变量，一维框架仍是学习基础理论和理解核心概念的理想切入点。）
...
关注动力系统之必要性，究其根本在于可借助其探究动力学本质特性！
...
动态系统的一个典型例子是状态空间 $S=\mathbb R$ 且映射函数 $g(x)=ax + b$ ，其中 $a, b$ 是常数（有时称为"参数"）。
...
对于所有非负整数 $t$，均可求得 $x_t$ 的精确解析式，从而充分把握系统动力学特性。
