...
处理复杂概率计算，最重要的工具之一是[蒙特卡罗方法](https://en.wikipedia.org/wiki/Monte_Carlo_method)。
...
所有关于统计的优质参考资料（如 [维基百科](https://en.wikipedia.org/wiki/Log-normal_distribution)）都会告诉我们，其均值和方差为
